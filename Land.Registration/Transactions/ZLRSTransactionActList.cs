...
//    public LRSTransactionConceptsList(int capacity) : base(capacity) {
//      // no-op
//    }

//    public LRSTransactionConceptsList(List<LRSTransactionAct> list) : base(list) {
//      this.CalculateTotals();
//    }

//    public LRSTransactionConceptsList(Func<DataRow, LRSTransactionAct> parser, DataView view) : base(parser, view) {
//      this.CalculateTotals();
//    }
